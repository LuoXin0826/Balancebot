all:
	...
	@make -C test_mpu --no-print-directory
	@make -C test_dmp --no-print-directory
	@make -C calibrate_accel --no-print-directory
	@make -C calibrate_gyro --no-print-directory
	@make -C pendulum_test --no-print-directory
